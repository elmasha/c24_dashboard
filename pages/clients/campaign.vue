          ...
          <v-card class="hero-panel pa-6 mb-5" outlined>
            <div class="d-flex flex-wrap align-center">
              <div class="hero-copy-wrap d-flex align-center">
                ...
                <div class="hero-copy">
                  <div class="hero-kicker" style="margin-left: 17px">
                    Campaign Library
                  </div>
                  ...
                  <div class="hero-subtitle" v-if="overview.client">
                    ...
                    <strong>{{ overview.client.client_name }}</strong
                    >, including impressions, scans, conversion rate, and
                    campaign duration.
                  </div>
                </div>
              </div>
            ...
            >
              ...
              <div class="campaign-card-top">
                ...
                <div
                  ...
                  v-show="overview.client && overview.client.qr"
                >
                  <v-progress-circular
                    max="100"
                    width="5"
