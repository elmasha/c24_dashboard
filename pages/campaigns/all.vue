                ...
                <v-simple-table class="table-dark">
                    ...
                    <tbody>
                        <tr v-for="campaign in campaigns" :key="campaign.id">
                            ...
                            <td>
                                <span class="status-pill" :class="campaign.status === 'active' ? 'status-active' : 'status-inactive'">
                                    {{ campaign.status }}
                                </span>
                            </td>
                            <td>
                            ...
                            <td class="text-right">
                                <div class="action-wrap">
                                    ...
                                    <v-btn x-small text color="#ff6b6b" class="mb-1" :loading="deletingId === campaign.id" @click="deleteCampaign(campaign)">
                                        Delete
                                    </v-btn>
                                </div>
                            </td>
