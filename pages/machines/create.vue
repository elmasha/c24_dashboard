    ...
    <v-app-bar flat color="transparent" height="72" class="admin-topbar px-4">
      <div class="d-flex align-center">
        ...
        <div>
          ...
          <h1 class="page-title">Create Machine</h1>
        </div>
      </div>
        ...
        <v-card class="panel-card pa-5" outlined>
          <div class="panel-head mb-4">
            <div>
              ...
              <div class="panel-title">New Machine Details</div>
            </div>
          </div>

          <v-form @submit.prevent="createMachine">
            <v-row>
              <v-col cols="12" md="6">
                <v-text-field
  ...
  methods: {
    ...
    async createMachine() {
      try {
        ...
        const { data } = await api.post("/api/machines", this.form);
