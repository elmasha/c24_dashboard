          ...
          <div class="d-flex flex-wrap align-center">
            <div class="hero-copy" style="margin-left: 10px">
              ...
              <div class="hero-heading">
                Monitor machine status, control availability, and manage
                deployment points
              </div>
              <div class="hero-subtext">
                View machine health, location, category, heartbeat activity, and
                quickly switch between manual and auto operation modes.
              </div>
            </div>
