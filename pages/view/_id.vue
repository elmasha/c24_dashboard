        ...
        <v-card class="hero-panel pa-6 mb-5" outlined>
            <div class="d-flex flex-wrap align-center">
                <div class="hero-copy-wrap d-flex align-center">
                    <v-avatar size="64" :color="campaign.image_url ? 'transparent' : '#73D843'" class="hero-campaign-avatar mr-4">
                ...
                <div class="hero-status-wrap mt-4 mt-md-0">
                    <v-chip outlined color="#73D843" class="status-chip" style="margin-right: 10px">
                        {{ campaign.status }}
                    </v-chip>
                </div>
            </div>
        ...
        <div class="summary-grid">
            ...
            <div class="summary-card qr-summary-card" v-show="campaign && campaign.show_qr">
                ...
                <div class="qr-wrap">
                    ...
                    <v-btn icon small class="qr-download-btn" @click="
                downloadQr(
        ...
        <v-row class="mt-2">
            <v-col cols="12" md="6">
                <v-card class="panel-card pa-5" outlined>
                    ...
                    <div class="image-preview-container" v-else-if="campaign && campaign.image_url">
                        <v-img :src="campaign.image_url" height="320" class="campaign-image-preview" contain />
                    </div>
                        ...
                        <tr v-for="machine in assignedMachines" :key="machine.id">
                            ...
                            <td>
                                <div class="machine-media-preview">
                                    <template v-if="machine.media_url && isVideo(machine.media_url)">
                                        <video height="100" muted width="200" playsinline controls>
